...
'// 开始时间:    2009.08.24
'// 最后修改:    2009.08.24
'// 备    注:    ASP版MD5编码，与PHP的MD5结果一致，用于网上银行和UCenter整合
'///////////////////////////////////////////////////////////////////////////////

Function MD5(str)
	Dim clsMD5
	Set clsMD5 = new Md5_Class_two
	MD5 = clsMD5.P_MD5(str)
	Set clsMD5 = Nothing
End Function
...
Public Function P_MD5(sMessage)
    m_lOnBits(0) = CLng(1)
    m_lOnBits(1) = CLng(3)
    m_lOnBits(2) = CLng(7)
    m_lOnBits(3) = CLng(15)
    ...
    For k = 0 To UBound(x) Step 16
        ...
        d = AddUnsigned(d, DD)
    Next
    P_MD5 = LCase(WordToHex(a) & WordToHex(b) & WordToHex(c) & WordToHex(d))
End Function
